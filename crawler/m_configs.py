...
GET_ITEM_QUANTITY_SCRIPT = "return document.querySelector('body > div > div > div > div > div > main > div > div > div > div > mer-text').textContent"  

GET_ITEM_NAME = "return document.querySelector('#item-info > section:nth-child(1) > div > mer-heading').shadowRoot.querySelector('h1').textContent"
